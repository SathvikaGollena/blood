        ...
        <div class="wrap">
            <div class="h_btm">
                <div class="header-para">
                    <img src="Images/donor1.png" height="80px" />
                    ...
                    <p class="top">Our volunteer/staff will ask you to fill a form with brief information on contact details and medical history.</p>
                    <h4>Physical Health check-up</h4>
                    <p class="top">You will be examined by a doctor to answer some questions about your health history. Your blood pressure and hemoglobin level will be checked.</p>
                    <h4>Blood Donation</h4>
                    <p class="top">We will cleanse an area on your arm and insert a brand new sterile needle for the blood draw. This feels like a quick pinch and is over in seconds.</p>
                    <ul style="list-style-type:disc; color:#805752" >
                    ...
                    <h4>Relax & Refresh</h4>
                    <p class="top">You can have something to eat and drink in and relax for about 15-20 minutes before departing. Within 24-48 hours your blood volume is completely restored. Apart from enjoying our refreshments and souvenir, other things to help you recover quickly include</p>
                    <ul style="list-style-type:disc; color:#805752" >
                    ...
                    <p class="top">Tell your friends, colleagues and family about the wonderful feeling you experience on donating blood and saving lives. Enjoy the feeling of knowing that you helped save precious lives!</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="ftr-bg">
    <div class="wrap">
        <div class="footer">
            ...
            <li><a href="Admin/admimlogin.php">Admin Login</a></li></li>
                </ul>
            </div>
            <div class="copy">
