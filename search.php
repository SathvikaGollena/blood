    ...
    <div style="height: 350px;">
        <form method="post" enctype="multipart/form-data">
            <table cellpadding="0" cellspacing="0" width="500px" height="250px" class="tableborder" style="margin:auto; margin-top:100px;" >
                ...
                <tr><td class="lefttd" style="padding-left:40px">Select Blood Group </td>
                    <td>
                        ...
                        if(isset($_POST["show"]))
                        {
                            ...
                            echo "<br />Selected Blood Group: $bg_name (ID: $bg_id)";
                            mysqli_close($cn);
                        }
                        ?>
                    </td>
                ...
                <tr><td colspan="2">&nbsp;</td></tr>
                <tr>
                    <td class="lefttd" style="padding-left:40px">Enter Pincode</td>
...
if(isset($_POST["sbmt"]))
{
    echo "<script>location.replace('result.php?bg=". $_POST["s2"] ."&pincode=".$_POST["pincode"]."');</script>";
}
?>
