            ...
            <table cellpadding="0" cellspacing="0" style="margin:auto; width:100%; " >
                ...
                <tr>
                    <td style=" padding-left:20px;" >
                        <img src="Images/sidebanner.jpg" width="170px" class="shaddoww"/>&nbsp;
                    </td>
                    <td style="vertical-align:top;padding-top:20px;">
                        <table cellpadding="0" cellspacing="0" style="width:100%; height:400px;">
                            ...
                            <tr><td class="lefttd">Upload Health Card</td><td><input type="file" name="t8" /></td></tr>
                            <tr><td class="lefttd">Pincode</td><td><input type="text" name="t9" required="required" pattern="[0-9]{6}" title="Please enter a 6-digit pincode" /></td></tr>
                            <tr><td>&nbsp;</td><td><input type="submit" value="Register" name="sbmt" style="border:0px; background:linear-gradient(#900,#D50000); width:100px; height:30px; border-radius:10px 1px 10px 1px; box-shadow:1px 1px 5px black; color:white; font-weight:bold; font-size:14px; text-shadow:1px 1px 6px black; "></td></tr>
                        </table>
                    </td>
                </tr>
            </table>
    ...
    if(isset($_POST["sbmt"])) 
    {
        ...
        if($imageFileType != "jpg" && $imageFileType !="png" && $imageFileType !="jpeg" && $imageFileType !="gif"){
            ...
            if(move_uploaded_file($_FILES["t8"]["tmp_name"], $target_file)){
                $cn=makeconnection();
                $s="insert into donarregistration(name,gender,age,mobile,b_id,email,pwd,pic,Pincode) values('" . $_POST["t1"] ."','" . $_POST["r1"] . "','" . $_POST["t2"] . "','" . $_POST["t3"] . "','" . $_POST["t4"] . "','" . $_POST["t5"] . "','" . $_POST["t6"] .  "','" . basename($_FILES["t8"]["name"])  ."','" . $_POST["t9"] . "')";
                mysqli_query($cn,$s);
                mysqli_close($cn);
                if($s>0)
                {
