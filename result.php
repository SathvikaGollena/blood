...
$s="select * from donarregistration,bloodgroup where donarregistration.b_id='$bg_id' and donarregistration.b_id=bloodgroup.bg_id and donarregistration.pincode='$pincode'";
...
?>
  <tr><td  >
            <table cellpadding="0" cellspacing="0" width="700px" height="150px" style="margin:auto; border:none;" class="tableborder">
                <tr><td width="1000px"  align="center" style="vertical-align:middle">
                    <a href="doner_pic<?php echo $data[8] ?>" data-lightbox="image-1"> 
                        <img src="doner_pic/<?php echo $data[8] ?>" height="100px" width="100px" style="margin:auto; padding-left:70px; padding-right:50px; float:left" />
                    </a>
                </td> 
