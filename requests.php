        ...
        <form method="post" enctype="multipart/form-data">
            <table cellpadding="0" cellspacing="0" width="500px" height="480px" style="margin:auto" >
                ...
                <tr><td class="lefttd" align="center">Till Required Date</td><td>
                    ...
                    <input type="text" name="year" style=" width:50px" />
                </td></tr>
                <tr><td>&nbsp;</td></tr>
                <tr><td class="lefttd" align="center">Detail</td><td><textarea name="t7"></textarea></td></tr>
                <tr><td>&nbsp;</td></tr>
                <tr><td class="lefttd" align="center">Pincode</td><td><input type="number" name="pincode" required="required" pattern="[0-9]{6}" title="Please enter 6-digit pincode" /></td></tr>
                <tr><td>&nbsp;</td></tr>
                <tr><td>&nbsp;</td><td><input type="submit" value="Submit" name="sbmt" style="border:0px; background:linear-gradient(#900,#D50000); width:100px; height:30px; border-radius:10px 1px 10px 1px; box-shadow:1px 1px 5px black; color:white; font-weight:bold; font-size:14px; text-shadow:1px 1px 6px black; "></td></tr>
            </table>
        </form>
    </div>
...
if(isset($_POST["sbmt"])) 
{
    ...
    $s="insert into requestes(name,gender,age,mobile,bgroup,email,reqdate,detail,pincode) values('" . $_POST["t1"] ."','" . $_POST["r1"] . "','" . $_POST["t2"] . "','" . $_POST["t3"] . "','" . $_POST["t4"] . "','" . $_POST["t5"] . "','" . $d .  "','" .  $_POST["t7"]  ."','" . $_POST["pincode"] . "')";
    $q=mysqli_query($cn,$s);
    mysqli_close($cn);
    if($q>0)
    {
